...
INDICATORS = [
    ...
    dict(name="SAVI", category=IndicatorCategory.VEGETATION, unit="index", color="#65a30d", icon="🍃",
         ...
         supported_dataset="Sentinel-2, Landsat 8", default_resolution="10 m",
         min_value=-0.2, max_value=0.9, color_palette='["#a50026","#fee08b","#66bd63","#1a9850"]'),
    dict(name="Vegetation Biomass (Biomasse végétale)", category=IndicatorCategory.VEGETATION, unit="t/ha", color="#4d7c0f", icon="🌳",
    ...
    dict(name="Soil Moisture (Humidité des sols)", category=IndicatorCategory.WATER, unit="%", color="#38bdf8", icon="🌧️",
    ...
    dict(name="Water Availability (Disponibilité en eau)", category=IndicatorCategory.WATER, unit="%", color="#0284c7", icon="🏞️",
    ...
    # Température
    dict(name="Land Surface Temperature (Température de surface)", category=IndicatorCategory.TEMPERATURE, unit="°C", color="#ef4444", icon="🌡️",
    ...
    dict(name="Thermal Anomalies (Anomalies thermiques)", category=IndicatorCategory.TEMPERATURE, unit="°C", color="#dc2626", icon="🔥",
    ...
    # Climat
    dict(name="Precipitation (Précipitations)", category=IndicatorCategory.CLIMATE, unit="mm", color="#6366f1", icon="🌦️",
    ...
    dict(name="Drought Index (Sécheresse)", category=IndicatorCategory.CLIMATE, unit="index", color="#a16207", icon="🏜️",
    ...
    dict(name="Evapotranspiration (Évapotranspiration)", category=IndicatorCategory.CLIMATE, unit="mm", color="#0891b2", icon="💨",
    ...
    dict(name="Land Cover Change (Changement d'occupation du sol)", category=IndicatorCategory.LAND_COVER, unit="%", color="#7c3aed", icon="🏗️",
    ...
    # Population
    dict(name="Population Density (Densité de population)", category=IndicatorCategory.POPULATION, unit="hab/km²", color="#ec4899", icon="🏙️",
    ...
    dict(name="Population Distribution (Répartition spatiale)", category=IndicatorCategory.POPULATION, unit="hab", color="#db2777", icon="👥",
    ...
    dict(name="Land Degradation (Dégradation)", category=IndicatorCategory.DEGRADATION, unit="NDVI/year", color="#b45309", icon="📉",
    ...
    dict(name="Land Restoration (Restauration)", category=IndicatorCategory.DEGRADATION, unit="NDVI/year", color="#92400e", icon="🌾",
         ...
         supported_dataset="Sentinel-2", default_resolution="30 m",
         min_value=-0.05, max_value=0.05, color_palette='["#a50026","#ffffbf","#1a9850"]'),
    dict(name="Critical Zones (Zones critiques)", category=IndicatorCategory.DEGRADATION, unit="%", color="#78350f", icon="⚠️",
         ...
         min_value=0, max_value=100, color_palette='["#ffffcc","#fd8d3c","#800026"]'),
    # Risques
    dict(name="Vulnerability (Vulnérabilité)", category=IndicatorCategory.RISK, unit="index", color="#e11d48", icon="🚨",
    ...
    dict(name="Exposure (Exposition)", category=IndicatorCategory.RISK, unit="index", color="#be123c", icon="📡",
         ...
         supported_dataset="Not yet supported", default_resolution="—",
         min_value=None, max_value=None, color_palette=None),
    dict(name="Sensitivity (Sensibilité)", category=IndicatorCategory.RISK, unit="index", color="#9f1239", icon="🎯",
